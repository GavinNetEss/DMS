...
namespace DBUtility
{
    public class DbHelperOra
    {
            ...
            //public static string _connectionString = BaseOperate.MpEncoding.GetDecoding("ㄣ㈋や㈋ж耂たもふ㉻㉣∵" + ConfigurationManager.AppSettings["㈋耂たも"].ToString() + "ㄨ虍へ㉣ふжㄓ㉯∵" + ConfigurationManager.AppSettings["虍ㄓ㉯"].ToString() + "ㄨㄡ㈋へへねたふ㉯∵" + ConfigurationManager.AppSettings["へねふ"].ToString());
            public static string _connectionString = ConfigurationManager.AppSettings["ApplicationServices"].ToString();
            public DbHelperOra()
            {
            }
           ...
           // private static string _connectionString;
            ...
            #region 公用方法
            public static string GetMaxEID(string FieldName, string TableName)
            {
